...
export const cycle1array = writable(undefined); // sorted array after cycle1 (for use in pile2)
export const cycle2array = writable(undefined); // sorted array after cycle2 (for use in pile3)
