...
<div class="centered-wrapper">
  ...
  <div class='containerButton'>
    {#if !animationStarted}
      <p class='description'>We'll split the deck into three face-up piles <span class="first">again</span>. Always remember to keep an eye on which pile your card ends up in!</p>
