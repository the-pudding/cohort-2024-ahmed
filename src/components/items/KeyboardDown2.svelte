...
<style>
  ...
  .key.down { opacity:1; }                /* keep the “down” key fully opaque */
...
<div class='position'>
  <div class="container">
    <div class="keyboard">
      ...
      <button class="key {activeKey === 'up' ? 'active' : ''}"
      ...
      <button class="key down {activeKey === 'down' ? 'active' : ''}"
    ...
    <div class="instruction">Press the ‘Down key’ to see what’s really happening!</div>
  </div>
</div>
